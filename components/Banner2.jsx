      ...
      <div className="sm:mx-10 mx-0 bg-cover bg-center" style={{ backgroundImage: 'url("https://voltron.id/_next/image?url=%2Fwebsite%2Fabout-us-bg.png&w=1920&q=70")' }}>
        <div className="flex sm:p-32 p-12 items-center sm:w-1/2 w-full">
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-white font-normal sm:text-xl text-lg">Our goal is to provide a convenient, reliable charging network across Indonesia. Available in offices, malls, highways and residential areas.</h1>
          </div>
        </div>
      </div>
    </div>
