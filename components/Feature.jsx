      ...
      <div className="flex flex-col gap-6 justify-center item-center text-center px-12">
        ...
        <div className="flex gap-10 w-full">
          <div className="flex flex-col gap-6">
            <Image src="/images/index/sklu.png" alt="Logo" width={1200} height={400} layout="fixed" />
          ...
          <div className="flex flex-col gap-6">
            <Image src="/images/index/adtec.png" alt="Logo" width={1200} height={400} layout="fixed" />
          ...
          <div className="flex flex-col gap-6">
            <Image src="/images/index/oneeco.png" alt="Logo" width={1200} height={400} layout="fixed" />
