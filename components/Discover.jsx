        ...
        <div className="flex flex-col gap-6 w-1/2 ">
          ...
          <h1 className="text-black text-xl font-normal">
            ...
            <div className="flex gap-6 mt-6">
              <Image src="/images/index/play.png" alt="Logo" width={150} height={400} layout="fixed" />
              <Image src="/images/index/appstore.png" alt="Logo" width={150} height={400} layout="fixed" />
            </div>
          </h1>
        </div>
        <div>
          <Image src="/images/index/discover.png" alt="Logo" width={400} height={400} layout="fixed" />
        </div>
      </div>
    </div>
  );
